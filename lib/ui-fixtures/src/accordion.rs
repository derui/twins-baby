    ...
    view! {
        <div class="flex flex-col gap-4 p-4">
            <div data-fixture="accordion-default">
                <TreeAccordion node=|| view! { "Default Section" }>
                    <div>"Content inside default accordion"</div>
                </TreeAccordion>
            </div>

            <div data-fixture="accordion-initial-open">
                <TreeAccordion node=|| view! { "Initially Open Section" } initial_open=true>
                    <div>"Content inside initially open accordion"</div>
                </TreeAccordion>
            </div>

            <div data-fixture="accordion-nested">
                <TreeAccordion node=|| view! { "Parent Section" } initial_open=true>
                    <div>"Parent content"</div>
                    <TreeAccordion node=|| view! { "Child Section" }>
