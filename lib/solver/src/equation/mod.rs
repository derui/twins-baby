...
mod tests {
    ...
    #[test]
    fn test_arithmetic_equations_equal_with_same_structure() -> color_eyre::eyre::Result<()> {
        // arrange
    ...
    #[test]
    fn test_arithmetic_equations_not_equal_with_swapped_operands() -> color_eyre::eyre::Result<()> {
        // arrange
        let const1: Equation = 5.0.into();
        let const2: Equation = 3.0.into();
        let eq1: Equation =
    ...
    #[test]
    fn test_different_equation_types_not_equal() -> color_eyre::eyre::Result<()> {
        // arrange
    ...
    #[test]
    fn test_cloned_equations_are_equal() -> color_eyre::eyre::Result<()> {
        // arrange
        let const1: Equation = 5.0.into();
        let const2: Equation = 3.0.into();
